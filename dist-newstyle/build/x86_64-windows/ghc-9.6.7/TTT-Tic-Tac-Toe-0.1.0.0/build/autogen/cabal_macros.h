...
/* package TTT-Tic-Tac-Toe-0.1.0.0 */
#ifndef VERSION_TTT_Tic_Tac_Toe
#define VERSION_TTT_Tic_Tac_Toe "0.1.0.0"
#endif /* VERSION_TTT_Tic_Tac_Toe */
#ifndef MIN_VERSION_TTT_Tic_Tac_Toe
#define MIN_VERSION_TTT_Tic_Tac_Toe(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_TTT_Tic_Tac_Toe */
/* package async-2.2.5 */
